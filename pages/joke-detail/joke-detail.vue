<template>
    <view class="joke_container">
        <view class="joke_container_hot">
            <view class="joke_container_hot_title"><text>最热评论</text></view>
            <view class="emptyText" v-if="hotList.length === 0"><text>[ 无 ]</text></view>
        ...
        <view class="joke_container_normal">
            <view class="joke_container_normal_title"><text>最新评论</text></view>
            <view class="emptyText" v-if="normalList.length === 0"><text>[ 无 ]</text></view>
